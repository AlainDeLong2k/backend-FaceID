...
from app.core.config import MODEL_PATH, MODEL_INPUT_SHAPE
...
class FaceVerificationService:
    ...
    def __init__(self):
        ...
        self.model_path_weights = (
            MODEL_PATH  # Đây là đường dẫn đến file .h5 chứa trọng số
        )
        self.model_input_shape = MODEL_INPUT_SHAPE  # Ví dụ: (100, 100, 3)
